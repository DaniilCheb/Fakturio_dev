    ...
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="flex flex-col gap-1">
          <label className="font-medium text-[13px] text-[#474743] dark:text-[#999]">Due</label>
          <select
            value={dueDate ? (() => {
              ...
              // Find matching option or default to 14 days
        ...
        />
        <div className="flex flex-col gap-1">
          <label className="font-medium text-[13px] text-[#474743] dark:text-[#999]">Payment method</label>
          <div className="flex gap-2">
            {PAYMENT_METHOD_OPTIONS.map((option) => (
              <button
                ...
                className={`flex-1 h-[40px] px-3 py-2 rounded-lg text-[14px] font-medium transition-all duration-200 ${
          ...
          {errors.payment_method && (
            <p className="text-[12px] text-red-500">{errors.payment_method}</p>
          )}
        </div>
      </div>
    </div>
