          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-[10px]">
              {items.map((item, index) => {
                ...
                return (
                  <div key={item.id} className="grid grid-cols-[56px_1fr_120px_84px_84px] gap-[10px] items-start group relative">
                    {/* Qty */}
                    <div className="pl-0">
                      <Input
                        label="Qty"
            ...
            {/* Footer Actions */}
            <div className="flex items-center justify-between pt-4 border-t border-[#f0f0f0] dark:border-[#333]">
              <button
                type="button"
                onClick={addItem}
